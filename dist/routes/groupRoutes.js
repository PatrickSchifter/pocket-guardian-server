...
router.delete('/', auth_middleware_1.jwtAuthMiddleware, (req, res) => groupController.deleteGroup(req, res));
...
router.get('/invite', auth_middleware_1.jwtAuthMiddleware, (req, res) => groupController.getInvite(req, res));
